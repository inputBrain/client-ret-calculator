            ...
            <div className="flex flex-col gap-4 ">
                ...
                <div className="mt-2 grid grid-cols-2 items-center gap-2">
                    ...
                    <input
                        type="number"
                        value={stocksRate}
                        onChange={(e) => setStocksRate(Number(e.target.value))}
                        placeholder="Enter age"
                        className="h-11 min-w-[220px] rounded-xl border border-slate-200 bg-white px-4 text-[15px] text-slate-800 shadow-sm focus:outline-none focus-visible:ring-4 focus-visible:ring-indigo-200"
                    />
                </div>
            </div>
