                    ...
                    <div className="flex flex-col gap-10">
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex gap-4 max-tablet:flex-col">
                                ...
                                <div className="flex w-full flex-col gap-4">
                                    <div
                                        className="flex flex-1 flex-col gap-6 rounded-2xl px-8 py-12 max-tablet:gap-4 max-tablet:px-4 max-tablet:py-6 border border-gray-100 red p-6 shadow-[0_10px_30px_-1px_rgba(16,24,40,0.12),0_2px_6px_rgba(16,24,40,0.04)]">
                                        <div className="flex flex-col items-center gap-3">
                                            <div className="flex flex-col items-center gap-2">
                                                <div
                                                    className="text-sm font-bold uppercase text-indigo-800 max-tablet:text-center">
